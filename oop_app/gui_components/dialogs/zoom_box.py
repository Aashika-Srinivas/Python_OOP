...
import warnings
from tkinter import Scrollbar, Frame, Toplevel

from PIL import Image, ImageTk

"""
This class is used to display an image view screen and to zoom it
"""


class ZoomBox(object):
    def __init__(self, master, image):
        top = self.top = Toplevel(master)
        top.geometry('800x600')  # size of the main window
        top.rowconfigure(0, weight=1)  # make the CanvasImage widget expandable
        top.columnconfigure(0, weight=1)
        canvas = CanvasImage(top, image)  # create widget
